...
*/
//$config['base_url']	='http://inventarios.dev.com/inventarios/'; //APP_URL; 
//base url dinamica
$config['base_url'] = ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] == "on") ? "https" : "http");
$config['base_url'] .= "://".$_SERVER['SERVER_NAME']."/inventarios/";
...
$config['redis_host'] = 'localhost'; //   http://inventarios.dev.com
