$(function(){
  ...
  //socket : io.connect('http://www.almacen-it.com:8080'),
  socket : io.connect('http://inventarios.dev.com/inventarios:8080'),
...
if  ( (url_pedidos[2]=="gestionar_pedido_compra") || (url_pedidos[2]=="cancelado") || (url_pedidos[2]=="solicitar_modificacion")
  || (url_pedidos[2]=="pendiente_revision") || (url_pedidos[2]=="aprobado")) {  



                $.ajax({
                          url : '/inventarios/notificacion_compra',
                          data : {                             
...
if  ( (url_pedidos[2]=="pedido_detalle")  ) {  //estos son los que tienen el pedido del conteo
...
//para los vendedores
if  ( (url_pedidos[2]=="apartado_detalle")  ) {  //estos son los que tienen el pedido del conteo
    ...
    if  ( (hash_url=="/inventarios/listado_traspaso")  ) {  //estos son los que tienen el pedido del conteo
    ...
    if  ( (hash_url=="/inventarios/pedidos")  ) {  //estos son los que tienen el pedido del conteo
    ...
    if  ( (hash_url=="/inventarios/generar_pedidos")  ) { //pedido
    ...
    if  ( (hash_url=="/inventarios/traspasos")  ) { //pedido
